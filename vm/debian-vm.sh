...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -serial0 socket \
  -description "<div align='center'><a href='https://Helper-Scripts.com'><img src='https://raw.githubusercontent.com/tdsf/Proxmox/main/misc/images/logo-81x112.png'/></a>
...
echo "More Info at https://github.com/tdsf/Proxmox/discussions/1988"
